...
class _ProductEditState extends State<ProductEdit> {
  ...
  void initState() {
    FirebaseFirestore.instance
        ...
        .then((value) {
      setState(() {
        _testDec.text = value.data()['test'];
        _testCode.text = value.data()['test_code'];
        _testSpeciman.text = value.data()['speciman'];
        _testRepTime.text = value.data()['rep_time'];
        _mrp.text = value.data()['mrp'].toString();
        _b2bRate.text = value.data()['b2b_rate'].toString();
        isLoading = false;
      });
    });
    super.initState();
